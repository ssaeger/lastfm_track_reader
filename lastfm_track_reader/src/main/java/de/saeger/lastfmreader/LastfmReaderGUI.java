...
public class LastfmReaderGUI extends JFrame {
	...
	/**
	 * Is used for: The last.fm user name to fetch the recent tracks of.
	 */
	private JTextField textUser;
	/**
	 * Is used for: A Last.fm API key.
	 */
	private JTextField textKey;
	/**
	 * Is used for: The number of results to fetch per page. Maximum is 200.
	 */
	private JTextField textLimit;
	/**
	 * Is used for: The last.fm URL for this API service.
	 */
	...
	/**
	 * Is used for: The Number of pages to fetch. "all" = fetch all pages.
	 */
	...
	/**
	 * Displays the current status of the program. For example: Exceptions,
	 * Progress, ...
	 */
	...
	/**
	 * <b>Optional</b>: Is used for: The number of different Tracks. This
	 * information can increase the performance of the program because it do not
	 * have to resize the data structure and copy the data whenever the old one
	 * is full.
	 */
	...
	/**
	 * When the Button "Show Data" is clicked, this function initiate the
	 * process of presenting the loaded data in the table in the tab "Data".
	 */
	...
	/**
	 * When the Button "Load Data" is clicked, this function initiate the
	 * process of loading the data from the Last.fm API.
	 */
	...
	/**
	 * Displays status updates in the textArea in the "Settings" tab.
	 * 
	 * @param s
	 *            Status update
	 */
	public static void changeStatus(final String s) {
		textArea.setText(s + "\n" + textArea.getText());
